...
struct ComponentNavbar: View {
    var body: some View {
        ...
        .onAppear {
            ...
            // Selected item color (brand accent)
            appearance.stackedLayoutAppearance.selected.iconColor = UIColor(red: 231/255, green: 76/255, blue: 60/255, alpha: 1.0)
            appearance.stackedLayoutAppearance.selected.titleTextAttributes = [.foregroundColor: UIColor(red: 231/255, green: 76/255, blue: 60/255, alpha: 1.0)]
